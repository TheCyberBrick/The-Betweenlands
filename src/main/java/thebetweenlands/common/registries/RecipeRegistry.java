...
import thebetweenlands.common.recipe.*;
...
public class RecipeRegistry {
	...
	public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<AddWormToRodRecipe>> FISHING_ROD_WORM = RECIPE_SERIALIZERS.register("add_worm_to_fishing_rod", () -> new CustomRecipe.Serializer<>(AddWormToRodRecipe::new));
	public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<CircleGemRecipe>> CIRCLE_GEM = RECIPE_SERIALIZERS.register("add_circle_gem", () -> new CustomRecipe.Serializer<>(CircleGemRecipe::new));
	public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<CoatToolRecipe>> COAT_TOOL = RECIPE_SERIALIZERS.register("coat_tool", () -> new CustomRecipe.Serializer<>(CoatToolRecipe::new));
	public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<CleanToolRecipe>> CLEAN_TOOL = RECIPE_SERIALIZERS.register("clean_tool", () -> new CustomRecipe.Serializer<>(CleanToolRecipe::new));
	public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<DyeLurkerPouchRecipe>> DYE_LURKER_POUCH = RECIPE_SERIALIZERS.register("dye_lurker_pouch", () -> new CustomRecipe.Serializer<>(DyeLurkerPouchRecipe::new));
	public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<EmptyAspectVialRecipe>> EMPTY_ASPECT_VIAL = RECIPE_SERIALIZERS.register("empty_aspect_vial", () -> new CustomRecipe.Serializer<>(EmptyAspectVialRecipe::new));
	public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<HearthgroveTarringRecipe>> HEARTHGROVE_TARRING = RECIPE_SERIALIZERS.register("hearthgrove_tarring", () -> new CustomRecipe.Serializer<>(HearthgroveTarringRecipe::new));
	public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<HerbloreBookCopyRecipe>> HERBLORE_BOOK_COPY = RECIPE_SERIALIZERS.register("copy_herblore_book", () -> new CustomRecipe.Serializer<>(HerbloreBookCopyRecipe::new));
	public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<LifeCrystalRechargeRecipe>> LIFE_CRYSTAL_RECHARGE = RECIPE_SERIALIZERS.register("recharge_life_crystal", () -> new CustomRecipe.Serializer<>(LifeCrystalRechargeRecipe::new));
	public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<UpgradeFishBaitRecipe>> UPGRADE_FISH_BAIT = RECIPE_SERIALIZERS.register("upgrade_fish_bait", () -> new CustomRecipe.Serializer<>(UpgradeFishBaitRecipe::new));

...
public class FarmerAdvancementProvider implements AdvancementGenerator {
	...
	public void generate(HolderLookup.Provider registries, Consumer<AdvancementHolder> consumer, ExistingFileHelper helper) {
		...
		var compost = Advancement.Builder.advancement().parent(fertile).display(ItemRegistry.COMPOST,
				...
				null, AdvancementType.TASK, true, true, false)
			.addCriterion("compost", ItemUsedOnLocationTrigger.TriggerInstance.itemUsedOnBlock(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(registries.lookupOrThrow(Registries.BLOCK), BlockRegistry.DUG_SWAMP_DIRT.get(), BlockRegistry.DUG_SWAMP_GRASS.get()).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(DugSoilBlock.COMPOSTED, false))), ItemPredicate.Builder.item().of(registries.lookupOrThrow(Registries.ITEM), ItemRegistry.COMPOST)))
		...
		Advancement.Builder.advancement().parent(pear).display(ItemRegistry.PEARLED_PEAR,
			...
			.addCriterion("eat_pear", ConsumeItemTrigger.TriggerInstance.usedItem(registries.lookupOrThrow(Registries.ITEM), ItemRegistry.PEARLED_PEAR))
		...
		Advancement.Builder.advancement().parent(compost).display(ItemRegistry.MARSH_MARIGOLD_FLOWER_DROP,
				...
				null, AdvancementType.TASK, true, true, false)
			.addCriterion("flower", ItemUsedOnLocationTrigger.TriggerInstance.itemUsedOnBlock(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(registries.lookupOrThrow(Registries.BLOCK), BlockRegistry.DUG_SWAMP_DIRT.get(), BlockRegistry.DUG_SWAMP_GRASS.get(), BlockRegistry.PURIFIED_DUG_SWAMP_DIRT.get(), BlockRegistry.PURIFIED_DUG_SWAMP_GRASS.get()).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(DugSoilBlock.COMPOSTED, true))),
				ItemPredicate.Builder.item().of(registries.lookupOrThrow(Registries.ITEM), BlockRegistry.EDGE_SHROOM, BlockRegistry.EDGE_MOSS, BlockRegistry.EDGE_LEAF, BlockRegistry.PITCHER_PLANT, BlockRegistry.WEEPING_BLUE, BlockRegistry.SUNDEW, BlockRegistry.VENUS_FLY_TRAP,
		...
		Advancement.Builder.advancement().parent(compost).display(BlockRegistry.PURIFIED_SWAMP_DIRT,
				...
				null, AdvancementType.TASK, true, true, false)
			.addCriterion("compost", ItemUsedOnLocationTrigger.TriggerInstance.itemUsedOnBlock(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(registries.lookupOrThrow(Registries.BLOCK), BlockRegistry.PURIFIED_DUG_SWAMP_DIRT.get(), BlockRegistry.PURIFIED_DUG_SWAMP_GRASS.get()).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(DugSoilBlock.COMPOSTED, false))), ItemPredicate.Builder.item().of(registries.lookupOrThrow(Registries.ITEM), ItemRegistry.COMPOST)))
		...
		var spores = Advancement.Builder.advancement().parent(compost).display(ItemRegistry.SPORES,
			...
			.addCriterion("break_fungus", BreakBlockTrigger.TriggerInstance.breakBlock(BlockPredicate.Builder.block().of(registries.lookupOrThrow(Registries.BLOCK), BlockRegistry.FUNGUS_CROP.get()).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(DecayableCropBlock.DECAYED, false).hasProperty(DecayableCropBlock.AGE, 15)).build()))
		...
		var kiss = Advancement.Builder.advancement().parent(root).display(ItemRegistry.OCHRE_SNAIL_SHELL,
				...
				null, AdvancementType.TASK, true, true, false)
			.addCriterion("snails", BredAnimalsTrigger.TriggerInstance.bredAnimals(Optional.of(EntityPredicate.Builder.entity().of(registries.lookupOrThrow(Registries.ENTITY_TYPE), EntityRegistry.MIRE_SNAIL.get()).build()), Optional.of(EntityPredicate.Builder.entity().of(registries.lookupOrThrow(Registries.ENTITY_TYPE), EntityRegistry.MIRE_SNAIL.get()).build()), Optional.empty()))
		...
		var thorax = Advancement.Builder.advancement().parent(root).display(ItemRegistry.PHEROMONE_THORAX,
				...
				null, AdvancementType.TASK, true, true, false)
			.addCriterion("thorax", ItemUsedOnLocationTrigger.TriggerInstance.itemUsedOnBlock(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(registries.lookupOrThrow(Registries.BLOCK), BlockRegistry.WEEDWOOD_BUSH.get())), ItemPredicate.Builder.item().of(registries.lookupOrThrow(Registries.ITEM), ItemRegistry.PHEROMONE_THORAX)))
		...
		var grub = Advancement.Builder.advancement().parent(thorax).display(ItemRegistry.SILK_GRUB,
				...
				null, AdvancementType.TASK, true, true, false)
			.addCriterion("grub", ItemUsedOnLocationTrigger.TriggerInstance.itemUsedOnBlock(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(registries.lookupOrThrow(Registries.BLOCK), BlockRegistry.MOTH_HOUSE.get())), ItemPredicate.Builder.item().of(registries.lookupOrThrow(Registries.ITEM), ItemRegistry.SILK_GRUB)))
		...
		Advancement.Builder.advancement().parent(house).display(BlockRegistry.GRUB_HUB,
				...
				null, AdvancementType.GOAL, true, true, false)
			.addCriterion("hub", ItemUsedOnLocationTrigger.TriggerInstance.itemUsedOnBlock(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(registries.lookupOrThrow(Registries.BLOCK), BlockRegistry.GRUB_HUB.get())), ItemPredicate.Builder.item().of(registries.lookupOrThrow(Registries.ITEM), ItemRegistry.PHEROMONE_EXTRACT_BUCKET)))

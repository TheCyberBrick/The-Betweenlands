...
public class EntityCircleGemData {

	private final List<CircleGem> gems;

	public static final Codec<EntityCircleGemData> CODEC = RecordCodecBuilder.create(instance -> instance.group(
		CircleGem.CODEC.listOf().fieldOf("gems").forGetter(o -> o.gems)
	).apply(instance, EntityCircleGemData::new));

	public EntityCircleGemData() {
		this(new ArrayList<>());
	}

	public EntityCircleGemData(List<CircleGem> gems) {
